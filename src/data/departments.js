...
export const departments = {
  languages: {
    ...
    topics: ["گرامر انگلیسی", "مکالمه انگلیسی", "آیلتس", "تافل", "لغات ضروری", "تلفظ", "Business English", "ترجمه", "آلمانی", "اسپانیایی"],
    about: {
      p1: "یادگیری زبان دریچه‌ای به دنیای تازه‌ای از ارتباطات، فرهنگ و فرصت‌های شغلی است. در دپارتمان زبان‌های خارجی کالج رکاد، چهار مهارت اصلی شنیدن، صحبت‌کردن، خواندن و نوشتن به‌صورت مرحله‌به‌مرحله و پروژه‌محور آموزش داده می‌شود؛ از دوره‌های مقدماتی A1 تا مسیرهای تخصصی آمادگی آزمون‌های بین‌المللی.",
      p2: "دوره‌های این دپارتمان به سه دستهٔ اصلی تقسیم می‌شوند: دوره‌های مقدماتی برای ساختن پایهٔ محکم گرامر و واژگان، دوره‌های کاربردی برای مکالمهٔ روزمره و محیط کار، و دوره‌های آمادگی آزمون‌های بین‌المللی مانند IELTS و TOEFL برای مهاجرت تحصیلی و کاری. هر دوره با تمرین و بازخورد مستقیم مدرس همراه است.",
    },
    faqs: [
      { q: "آیا بدون هیچ پیش‌زمینه‌ای می‌توانم زبان انگلیسی را یاد بگیرم؟", a: "بله؛ دوره‌های مقدماتی دپارتمان از سطح A1 طراحی شده‌اند و مناسب کسانی هستند که هیچ پیش‌زمینه‌ای ندارند. با نقشهٔ راه شفاف، از الفبا و واژگان پایه شروع می‌کنید و قدم‌به‌قدم جلو می‌روید." },
      { q: "یادگیری آنلاین زبان به اندازهٔ کلاس حضوری موثر است؟", a: "با انتخاب دوره‌های اصولی با مدرسین حرفه‌ای، آموزش آنلاین می‌تواند دقیقاً به اندازهٔ کلاس حضوری موثر باشد؛ حتی انعطاف بیشتری برای تمرین و مرور به شما می‌دهد." },
      { q: "برای قبولی در آیلتس از کدام دوره شروع کنم؟", a: "اگر سطح متوسط دارید، مستقیم سراغ دورهٔ جامع آمادگی IELTS بروید؛ اگر پایه‌تان کمتر است، ابتدا مسیر توسعه (B1 → B2) را طی کنید تا وارد دورهٔ آزمون شوید." },
      { q: "مدارک دوره‌ها اعتبار بین‌المللی دارد؟", a: "پس از پایان هر دوره گواهی‌نامهٔ معتبر کالج رکاد صادر می‌شود که در رزومه و پروفایل‌های حرفه‌ای قابل استعلام و ارائه است." },
    ],
  },
  ...
  business: {
    ...
    topics: ["دیجیتال مارکتینگ", "کارآفرینی", "MBA", "فروش و مذاکره", "رهبری", "حسابداری", "مدیریت پروژه", "برندینگ", "مالی", "منابع انسانی"],
    about: {
      p1: "مهارت‌های کسب‌وکار، تفاوت میان یک ایدهٔ خوب و یک کسب‌وکار موفق است. در دپارتمان کسب‌وکار کالج رکاد، آموزش‌ها مستقیماً از دل تجربهٔ کسب‌وکارهای واقعی استخراج شده‌اند؛ از اعتبارسنجی ایده و مدل درآمدی تا بازاریابی دیجیتال، فروش، رهبری تیم و مدیریت مالی.",
      p2: "دوره‌های این دپارتمان برای سه گروه طراحی شده‌اند: کسانی که می‌خواهند کسب‌وکار خودشان را راه بیندازند، مدیران و کارشناسانی که به‌دنبال رشد شغلی هستند، و سازمان‌هایی که قصد توانمندسازی نیروی انسانی دارند. هر مسیر با مطالعهٔ موردی و تمرین عملی از دنیای واقعی همراه است.",
    },
    faqs: [
      { q: "برای شروع دوره‌های کسب‌وکار پیش‌زمینه لازم است؟", a: "خیر؛ دوره‌های پایه مانند مبانی حسابداری و دیجیتال مارکتینگ از صفر شروع می‌شوند. برای دوره‌های پیشرفته‌تر مانند MBA کارآفرینی، تجربهٔ کاری بهتر است ولی الزامی نیست." },
      { q: "دوره‌های این دپارتمان برای راه‌اندازی استارتاپ مناسب هستند؟", a: "بله؛ مسیر کارآفرینی دپارتمان از یافتن ایده و اعتبارسنجی شروع می‌شود و تا مدل کسب‌وکار، MVP، Pitch Deck و جذب سرمایه را پوشش می‌دهد." },
      { q: "آیا دوره‌ها گواهی‌نامه دارند؟", a: "تقریباً همهٔ دوره‌های دپارتمان با پایان‌یافتن و قبولی در پروژهٔ نهایی، گواهی‌نامهٔ قابل استعلام کالج رکاد را صادر می‌کنند." },
      { q: "کدام دوره برای استخدام و پیشرفت شغلی بهترین است؟", a: "به هدف شما بستگی دارد؛ برای ورود به بازار کار، دیجیتال مارکتینگ ۳۶۰° و مدیریت پروژهٔ Scrum بیشترین تقاضا را دارند و برای مدیران، مسیر رهبری و OKR پیشنهاد می‌شود." },
    ],
  },
  ...
  it: {
    ...
    topics: ["برنامه‌نویسی", "فرانت‌اند", "بک‌اند", "پایتون و AI", "DevOps", "امنیت", "موبایل", "دیتابیس", "سئو فنی", "React"],
    about: {
      p1: "مهارت‌های فناوری اطلاعات امروز پرتقاضاترین مهارت‌های بازار کار دنیاست. در دپارتمان فناوری اطلاعات کالج رکاد، همهٔ دوره‌ها پروژه‌محور طراحی شده‌اند و سرفصل‌هایشان توسط مهندسان شاغل در شرکت‌های تراز اول بازبینی می‌شود؛ از طراحی وب و برنامه‌نویسی تا امنیت، شبکه و هوش مصنوعی.",
      p2: "مسیرهای یادگیری دپارتمان به‌گونه‌ای چیده شده‌اند که در پایان هر دوره یک پروژهٔ واقعی برای رزومه داشته باشید. دوره‌های مقدماتی از صفر شروع می‌کنند و مسیرهای تخصصی فرانت‌اند، بک‌اند و امنیت، شما را تا سطح استخدام‌پذیری همراهی می‌کنند.",
    },
    faqs: [
      { q: "برای شروع برنامه‌نویسی به ریاضیات قوی نیاز دارم؟", a: "خیر؛ برای شروع فرانت‌اند و اکثر مسیرها، منطق ساده و پشتکار کافی است. دورهٔ HTML و CSS مدرن به‌عنوان نقطهٔ شروع بدون هیچ پیش‌نیازی طراحی شده است." },
      { q: "کدام مسیر شغلی برای ورود سریع به بازار کار بهتر است؟", a: "فرانت‌اند و بک‌اند سریع‌ترین مسیرهای ورود به استخدام هستند. مسیر داده و AI و امنیت نیز درآمد بالاتری دارند ولی پیش‌نیاز بیشتری می‌خواهند." },
      { q: "آیا دوره‌ها همراه با پروژهٔ واقعی هستند؟", a: "بله؛ همهٔ دوره‌های دپارتمان پروژه‌محورند و در پایان هر مسیر، یک پروژهٔ کامل قابل ارائه در رزومه و گیت‌هاب تحویل می‌دهید." },
      { q: "پشتیبانی و رفع اشکال در طول دوره چطور انجام می‌شود؟", a: "در کنار هر دوره، تالار پرسش و پاسخ و گروه مطالعه فعال است و منتورهای دپارتمان پاسخگوی سوالات فنی شما تا پایان دوره هستند." },
    ],
  },
};
